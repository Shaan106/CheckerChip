...
#essentially ensures that you are running the right binary, otherwise hard to detect error (outputs jumble)
...
# you can exit simulation using m5 exit
# then do something useful ie switch to a more detailed processor for analysis
# then continue
# ie do bootup using fast processor
command = (
    "m5 exit;" 
...
board.set_kernel_disk_workload(
    # what to boot up device with
    kernel=Resource("x86-linux-kernel-5.4.49"),
    disk_image=Resource("x86-ubuntu-18.04-img"),

    # what to run once system is booted
